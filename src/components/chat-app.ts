...
class ChatApp {
  ...
  constructor(shadowRoot: ShadowRoot) {
    ...
    this.messages = this.shadowRoot.querySelector(
      ".messages-content"
    ) as HTMLElement
    this.d = new Date()
    this.h = 0
  ...
  private listeners() {
    this.ChatButtonComponent.initChatButton().render()
  ...
  private insertMessage() {
    this.msg = (
      this.shadowRoot.querySelector(".message-input") as HTMLInputElement
    ).value
